...
class ToolExecutionInputs:
    ...
    # TOOL-AUDIT-NORMALIZATION-V1 (2026-05-22): canonical audit
    # entry id generated by the live dispatcher at dispatch
    # start. Downstream paths (workspace's _execute_service_bound_tool)
    # see this and skip their own audit emission. Empty string =
    # no canonical entry exists; downstream paths emit as legacy.
    audit_entry_id: str = ""
